class Skillwick < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/churdaa/skillwick/releases/download/v0.2.0/skillwick-aarch64-apple-darwin.tar.xz"
    sha256 "a4a9cfff5b91c215f784d1f5fba4896350a133343f5544f974d6d589dd90172d"
  else
    url "https://github.com/churdaa/skillwick/releases/download/v0.2.0/skillwick-x86_64-apple-darwin.tar.xz"
